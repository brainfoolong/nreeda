...
if(!isset($_SERVER["argv"]) || !isset($_SERVER["argv"][1]) || !$_SERVER["argv"]) die("This file can only be called via PHP Command Line Interface and must contain at least one parameter");
